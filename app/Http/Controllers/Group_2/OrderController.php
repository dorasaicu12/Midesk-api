...
class OrderController extends Controller
{
     ...
     * @bodyParam order_id string require id of order.
     * @bodyParam products array optional The products array list .
     * @bodyParam products.image_product string optional Image of products.
     * @bodyParam products.code_product require optional Product code.
     * @bodyParam products.name_product require optional Product name.
