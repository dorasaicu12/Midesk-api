...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('public/icons/favicon-32x32.png') }}" sizes="32x32" />
  <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
  <link rel="icon" type="image/png" href="{{ asset('public/icons/favicon-16x16.png') }}" sizes="16x16" />
  <style>
    html
    {
    ...
    *:after
    ...
    .topbar-wrapper img {
      height: 50px;
      content: url({{ asset('public/icons/logo-main.jpg') }});
    }
    .swagger-ui .topbar{
